                        ...
                        <TableBody>
                            {filteredPrasadams.length === 0 ? (
                                ...
                                filteredPrasadams.map((prasadam) => (
                                    <TableRow key={prasadam._id} className={!prasadam.isActive ? "opacity-50" : ""}>
                                        <TableCell>
                                            {prasadam.image ? (
                                                <img
                                        ...
                                        <TableCell>
                                            <div>
                                                <p className="font-medium">{prasadam.title}</p>
                                                {prasadam.isFeatured && (
                                                    <span className="inline-flex items-center px-1.5 py-0.5 rounded text-[10px] font-medium bg-orange-100 text-orange-700 mt-1">
                                        ...
                                        <TableCell>
                                            <span className="capitalize">{categoryLabels[prasadam.category] || prasadam.category}</span>
                                        </TableCell>
                                        <TableCell>
                                            <div className="space-y-0.5">
                                                <p className="font-semibold text-green-700">{formatPrice(prasadam.basePrice)}</p>
                                                {prasadam.marketPrice && prasadam.marketPrice > prasadam.basePrice && (
                                                    <p className="text-xs text-muted-foreground line-through">{formatPrice(prasadam.marketPrice)}</p>
                                                )}
                                            </div>
                                        </TableCell>
                                        <TableCell>
                                            {prasadam.inStock ? (
                                                <span className="text-green-600 font-medium text-sm">{prasadam.stockQuantity || "In Stock"}</span>
                                            ) : (
