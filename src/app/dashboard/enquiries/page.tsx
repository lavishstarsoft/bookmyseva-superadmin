        ...
        <div className="space-y-6">
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-4">
                ...
                <TabsContent value="all" className="space-y-4">
                    <EnquiriesTable enquiries={filteredEnquiries} viewDetails={viewDetails} loading={loading} />
                </TabsContent>
            ...
            <Dialog open={!!selectedEnquiry} onOpenChange={(open) => !open && setSelectedEnquiry(null)}>
                <DialogContent className="max-w-2xl max-h-[90vh] p-0 overflow-hidden">
                    <div className="p-6 pb-0">
                        <DialogHeader>
                            <DialogTitle className="text-2xl text-[#8D0303] flex items-center gap-2">
                                <PartyPopper className="h-6 w-6" />
                                Booking Details
                            </DialogTitle>
                            <DialogDescription>
                                Review the complete details of the booking request.
                            </DialogDescription>
                        </DialogHeader>
                    </div>
...
function EnquiriesTable({ enquiries, viewDetails, loading }: { enquiries: Enquiry[], viewDetails: (e: Enquiry) => void, loading: boolean }) {
    if (loading) {
        return (
            <Card>
