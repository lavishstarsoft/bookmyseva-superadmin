    ...
    const handleSave = async () => {
        ...
        try {
            ...
            const kitData: Kit = {
                ...
                defaultRating: 4.8,
                reviewCount: 100,
                image: "https://images.unsplash.com/photo-1601314002592-b8734bca6604?q=80&w=400&auto=format&fit=crop" // Default for now
            };
            ...
            toast.error("Failed to save pooja kit");
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="space-y-6 pb-20 w-full">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-3xl font-bold tracking-tight">Add New Pooja Kit</h1>
                        <p className="text-muted-foreground text-sm">Create a new standardized kit for the platform.</p>
                    </div>
                </div>
